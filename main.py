...
# os.mkdir("quickve.txt")

# print(
#   os.listdir()
# )  # Lists all the files in the current directory. Useful for checking that a file is in the folder we think it is.

# os.rename("quickve.txt", "NEW.txt")
